    ...
    <ol>
        <li>
            ...
            <CopyBlock content='curl -s "https://rb-webstudio.go.yj.fr/chuck-norris-ipsum/api/?sentence_min=1&sentence_max=5&paragraph=2"' label="Copier">
                <pre><code>curl -s "https://rb-webstudio.go.yj.fr/chuck-norris-ipsum/api?sentence_min=1&amp;sentence_max=5&amp;paragraph=2"</code></pre>
            </CopyBlock>
        </li>
        <li>
            ...
            <CopyBlock content='curl -s "https://rb-webstudio.go.yj.fr/chuck-norris-ipsum/api/?sentence_min=1&sentence_max=5&paragraph=2&text=1"' label="Copier">
                <pre><code>curl -s "https://rb-webstudio.go.yj.fr/chuck-norris-ipsum/api/?sentence_min=1&amp;sentence_max=5&amp;paragraph=2&amp;text=1"</code></pre>
            </CopyBlock>
        </li>
    </ol>
