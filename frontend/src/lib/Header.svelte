...
<Modal bind:show={isHelpOpen} title="Aide à l'utilisation">
    ...
    <ol>
        <li>
            ...
            <CopyBlock content='curl -s "http://localhost:5000/api/?sentence_min=1&sentence_max=5&paragraph=2"' label="Copier">
        ...
        <li>
            ...
            <CopyBlock content='curl -s "http://localhost:5000/api/?sentence_min=1&sentence_max=5&paragraph=2&text=1"' label="Copier">
